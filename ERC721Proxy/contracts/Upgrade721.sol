 ...
 * {ERC721Enumerable}.
 */
contract GU_ERC721 is Initializable, Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view virtual returns (bool) {
        address owner = GU_ERC721.ownerOf(tokenId);
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        owner = GU_ERC721.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(GU_ERC721.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(GU_ERC721.ownerOf(tokenId), to, tokenId);
    }
...
contract Upgrade721 {
    ...
    function setFunctionBase(address _base) public {
        require(_base != address(0));
        functionBase = GU_ERC721(_base);
    }
    ...
    function approve(address to, uint256 tokenId) override public {
        address owner = Upgrade721.ownerOf(tokenId);
        ...
        (bool success, bytes memory dataReturn) = address(functionBase).delegatecall(
    ...
    function safeMint(address to, uint256 tokenId)  virtual override public {
        (bool success, bytes memory dataReturn) = address(functionBase).delegatecall(
